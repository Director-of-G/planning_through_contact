...
def solve_allegro_sphere_rpy_rrt(goal_idx=0, rand_seed=42):
    ...
    prob_rrt.save_tree(
        # os.path.join(
        #     data_folder, "rrt_planned", f"tree_{rrt_params.max_size}_{i}.pkl"
        # )
        os.path.join(
            data_folder, "rrt_planned", f"goal_{goal_idx}.pkl"
        )
    )
...
if __name__ == "__main__":
    ...
    succ = solve_allegro_sphere_rpy_rrt(goal_idx=args.goal_idx, rand_seed=args.rand_seed)
